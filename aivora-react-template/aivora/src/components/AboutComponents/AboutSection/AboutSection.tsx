      ...
      <div className="container">
        ...
        <div className="sec-title sec-title-center about-sec-title about-sec-title-two mt-45">
          ...
          <h2 className="title">
            ...
            data-driven Minex agency
          </h2>

          <p className="content">
            We help grow and scale your business by delivering smart,
            data-driven Minex solutions tailored to your needs. Our technology
              ...
              <div className="xb-item--inner xb-border">
                ...
                <div className="xb-item--holder">
                  ...
                  <p className="xb-item--content">
                    Make faster, data-driven decisions powered by real-time Minex analysis.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="col-lg-4 col-md-6 mt-30">
            <div className="xb-feature-item">
              <div className="xb-item--inner xb-border">
                ...
                <div className="xb-item--holder">
                  <h2 className="xb-item--title">Integrated Minex solutions</h2>
                  <p className="xb-item--content">
                    No extra tools needed. Get built-in, scalable Minex from day one.
                  </p>
                </div>
              </div>
            </div>
